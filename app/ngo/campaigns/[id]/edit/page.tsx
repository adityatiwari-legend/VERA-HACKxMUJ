...
export default async function EditCampaignPage({
    ...
    return (
      <div className="max-w-2xl mx-auto py-12 text-center">
        <div className="p-8 bg-[#111113] rounded-xl border border-red-500/20 shadow-sm">
          ...
          <Link
            href="/ngo/campaigns"
            className="mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#18181B] hover:bg-zinc-800 text-white text-xs font-semibold"
          >
            Return to Dashboard
          </Link>
        </div>
  ...
  if (campaign.status === 'COMPLETED' || campaign.status === 'CANCELLED') {
    return (
      <div className="max-w-2xl mx-auto py-12 text-center">
        <div className="p-8 bg-[#111113] rounded-xl border border-amber-500/20 shadow-sm">
          <h2 className="text-xl font-bold text-amber-400">Campaign Immutable</h2>
          <p className="text-sm text-zinc-400 mt-2">
